...
/**
 * Example of using Member Inner Class as event handler
 *
 * An event handler is the type of object that often needs access to the members of its outer class but likely won’t be
 * reused by another class, making it a good candidate for an inner class.
 */
